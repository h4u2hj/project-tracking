    ...
    var Journey = {
        run: function () {
            ...
            opaTest("#4: Check modifiedAt filter", function (Given, When, Then) {
                ...
                filterBarActions.iChangeFilterField({ property: "modifiedAt" }, "From Jan 1, 2023")
                    .and.iExecuteSearch()
            ...
            opaTest("#5: Check createdBy filter", function (Given, When, Then) {
                ...
                tableAssertions.iCheckRows({ "Created By": "email.1@example.net" }, 3)
            ...
            opaTest("#6: Check createdAt filter", function (Given, When, Then) {
                ...
                filterBarActions.iChangeFilterField({ property: "createdAt" }, "From Jan 1, 2008")
                    .and.iExecuteSearch()
            ...
            opaTest("#7: Check manager filter", function (Given, When, Then) {
                ...
                tableAssertions.iCheckRows({ "Manager": "firstName1 lastName1 (D107)" }, 3)
            ...
            opaTest("#8: Check type filter", function (Given, When, Then) {
                ...
                filterBarActions.iChangeFilterField({ property: "type_ID" }, "TypeName-3")
                    .and.iExecuteSearch()

                filterBarAssertions.iCheckFilterField({ property: "type_ID" }, "TypeName-3")
                tableAssertions.iCheckRows({ "Type": "TypeName-3" }, 2)
            ...
            opaTest("#9: Check status filter", function (Given, When, Then) {
                ...
                filterBarActions.iChangeFilterField({ property: "status_ID" }, "name-final")
                    .and.iExecuteSearch()

                filterBarAssertions.iCheckFilterField({ property: "status_ID" }, "name-final")
                tableAssertions.iCheckRows({ "Status": "name-final" }, 4)
            ...
            opaTest("#10: Check started on filter", function (Given, When, Then) {
                ...
                filterBarActions.iChangeFilterField({ property: "startDate" }, "Aug 13, 2011")
                    .and.iExecuteSearch()
            ...
            opaTest("#11: Check completed on filter", function (Given, When, Then) {
                ...
                filterBarActions.iChangeFilterField({ property: "startDate" }, "From Jan 1, 2009")
                    .and.iExecuteSearch()
